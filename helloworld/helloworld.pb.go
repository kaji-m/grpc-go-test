...
type HelloRequest struct {
	...
	MapStringString map[string]string `protobuf:"bytes,2,rep,name=map_string_string,json=mapStringString,proto3" json:"map_string_string,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	ByteSlice       []byte            `protobuf:"bytes,5,opt,name=byteSlice,proto3" json:"byteSlice,omitempty"`
	ByteSlices      [][]byte          `protobuf:"bytes,6,rep,name=byteSlices,proto3" json:"byteSlices,omitempty"`
}
...
func (x *HelloRequest) GetMapStringString() map[string]string {
	if x != nil {
...
func (x *HelloRequest) GetNested() *NestedMessage {
	if x != nil {
		return x.Nested
	}
	return nil
...
func (x *HelloRequest) GetStrings() []string {
	if x != nil {
		return x.Strings
	}
	return nil
...
func (x *HelloRequest) GetByteSlice() []byte {
	if x != nil {
		return x.ByteSlice
	}
	return nil
...
func (x *HelloRequest) GetByteSlices() [][]byte {
	if x != nil {
		return x.ByteSlices
	}
	return nil
...
func (x *NestedMessage) GetTest() string {
	if x != nil {
		return x.Test
	}
	return ""
...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x22, 0xcc, 0x02, 0x0a, 0x0c, 0x48, 0x65,
	...
	0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
	...
	,
...
var file_helloworld_helloworld_proto_goTypes = []interface{}{
	...
	(*NestedMessage)(nil), // 1: helloworld.NestedMessage
	(*HelloReply)(nil),    // 2: helloworld.HelloReply
	nil,                   // 3: helloworld.HelloRequest.MapStringStringEntry
}
var file_helloworld_helloworld_proto_depIdxs = []int32{
	3, // 0: helloworld.HelloRequest.map_string_string:type_name -> helloworld.HelloRequest.MapStringStringEntry
	1, // 1: helloworld.HelloRequest.nested:type_name -> helloworld.NestedMessage
